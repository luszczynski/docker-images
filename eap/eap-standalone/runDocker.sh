...
CMD_START="docker run -d -p 127.0.0.1:9990:9990 -p 127.0.0.1:8080:8080 --privileged --name $STANDALONE_CONTAINER_NAME";
...
sudo docker logs -f $STANDALONE_CONTAINER_NAME
